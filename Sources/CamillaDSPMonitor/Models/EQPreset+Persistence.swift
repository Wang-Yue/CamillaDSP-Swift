...
extension AppState {
    ...
    func addEQPreset(name: String = "New Preset") {
        let preset = EQPreset(name: name, bands: [
    ...
    func createDefaultEQPresetsIfNeeded() {
        ...
        let headphone = EQPreset(name: "Headphone EQ", bands: [
        ...
        let roomLeft = EQPreset(name: "Room EQ (Left)", bands: [
        ...
        let roomRight = EQPreset(name: "Room EQ (Right)", bands: [
